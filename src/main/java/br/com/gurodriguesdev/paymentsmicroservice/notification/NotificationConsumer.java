...
import br.com.gurodriguesdev.paymentsmicroservice.exception.NotificationException;
...
public class NotificationConsumer {
    ...
    public NotificationConsumer(RestClient.Builder builder) {
        ...
        @KafkaListener(topics = "transaction-notification", groupId = "payments-microservice-backend")
